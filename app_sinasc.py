...
st.title('Análise Sinasc Rondônia - 2019')

st.markdown("Este é um projeto do curso de cientista de dados da EBAC")

st.markdown("### Iremos analisar o banco de dados do Sinasc do estado de Rondônia do ano de 2019, mais informações sobre o que é o sinasc estão disponíveis abaixo.")
